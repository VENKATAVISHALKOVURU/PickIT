      ...
      default:
        return (
          <div className="animate-in slide-in-from-left-4 duration-300 pb-10">
            ...
            <button
              onClick={onLogout}
              className="w-full mt-6 py-4 text-rose-500 font-bold rounded-2xl text-sm active:scale-95 transition-transform flex items-center justify-center gap-2 hover:bg-rose-50"
            >
